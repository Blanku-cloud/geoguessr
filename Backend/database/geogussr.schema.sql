CREATE DATABASE IF NOT EXISTS geogussr;
USE geogussr;
...
(user_login_info_id, facebook_id, google_id, email_id) VALUES (1, NULL, NULL, "mecow@gmail.com"), (2, NULL, 123, NULL),
(3, 567, NULL, NULL);

CREATE TABLE IF NOT EXISTS user_data (
    user_login_info_id INTEGER PRIMARY KEY,
    FOREIGN KEY (user_login_info_id) REFERENCES user_login_info(id) ON DELETE CASCADE,
    xp INTEGER(255) NOT NULL DEFAULT 0,
    currentLevel Integer(255) NOT NULL DEFAULT 1,
    coins INTEGER(255) NOT NULL DEFAULT 0
);

-- seeding the user_data
INSERT IGNORE INTO user_data
(user_login_info_id, xp, coins)
...
INSERT IGNORE INTO guest_login_info
(id, username)
